...
function EvidenceIngestion({
  ...
  async function processFile(file) {
    ...
    if (!allowedExtensions.includes(extension)) {
      alert(
        "Unsupported file. Use PDF, TXT, PNG, JPG or WEBP."
      );
        ...
        {hashing ? (
          ...
          <>
            ...
            <div className="mb-4 rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
              ...
              <button
                onClick={copyHash}
                className="mt-3 flex items-center gap-2 rounded-md border border-slate-700 px-3 py-2 text-[10px]"
              >
                {copied ? (
                  <Check size={12} />
                ) : (
            ...
            <div className="mt-5 grid gap-2 sm:grid-cols-2">
              ...
              <button
                onClick={clear}
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-700 py-2.5 text-xs text-slate-400 hover:text-red-400"
              >
                <X size={14} />
                Remove Evidence
              </button>
          ...
          <div className="flex min-h-[200px] flex-col items-center justify-center text-center">
            ...
            <p className="mt-1 text-[10px] text-slate-700">
              Upload a file to generate fingerprint
            </p>
